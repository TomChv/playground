...
var file_messenger_messenger_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x6e, 0x67, 0x65, 0x72, 0x22, 0x31, 0x0a, 0x07, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e,
	...
	0x01, 0x28, 0x04, 0x52, 0x04, 0x64, 0x61, 0x74, 0x65, 0x32, 0x42, 0x0a, 0x10, 0x4d, 0x65, 0x73,
	0x73, 0x65, 0x6e, 0x67, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x2e, 0x0a,
	0x04, 0x53, 0x65, 0x6e, 0x64, 0x12, 0x12, 0x2e, 0x6d, 0x65, 0x73, 0x73, 0x65, 0x6e, 0x67, 0x65,
	0x72, 0x2e, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x1a, 0x12, 0x2e, 0x6d, 0x65, 0x73, 0x73,
	0x65, 0x6e, 0x67, 0x65, 0x72, 0x2e, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x42, 0x04, 0x5a,
...
var file_messenger_messenger_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_messenger_messenger_proto_goTypes = []interface{}{
	(*Content)(nil), // 0: messenger.Content
}
var file_messenger_messenger_proto_depIdxs = []int32{
	0, // 0: messenger.MessengerService.Send:input_type -> messenger.Content
	0, // 1: messenger.MessengerService.Send:output_type -> messenger.Content
...
func (c *messengerServiceClient) Send(ctx context.Context, in *Content, opts ...grpc.CallOption) (*Content, error) {
	out := new(Content)
	err := c.cc.Invoke(ctx, "/messenger.MessengerService/Send", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedMessengerServiceServer) Send(context.Context, *Content) (*Content, error) {
...
func _MessengerService_Send_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/messenger.MessengerService/Send",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MessengerServiceServer).Send(ctx, req.(*Content))
	}
